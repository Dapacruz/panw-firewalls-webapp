...
// Set dark mode on/off on page load
document.addEventListener("DOMContentLoaded", function() {
    const isDarkMode = localStorage.getItem("dark-mode") || "true";
    if (isDarkMode === "false") {
        document.body.classList.remove("dark-mode");
        toggleSwitch.checked = false;
        logo.src = "/static/img/palo-alto-networks-logo.png";
    }
});
...
toggleSwitch.addEventListener("change", function() {
    if (this.checked) {
        ...
        logo.src = "/static/img/palo-alto-networks-logo-dark.png";
    } else {
        document.body.classList.remove("dark-mode");
						...
						$('div.toolbar').html(`
							<div class="menu-wrap">
								...
								<div>
									...
									<li><a onclick="executeAnsiblePlaybook('${env.ansible_templates.upgrade_dynamic_content}')">Upgrade Dynamic Content</a></li>
									</ul>
									</div>
								</div>
								</div>
